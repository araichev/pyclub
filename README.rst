...
4. If you are working in a team, read `this article <https://www.atlassian.com/git/tutorials/comparing-workflows>`_. to learn more about different workflows which are possible using Git repositories. 
